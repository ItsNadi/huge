...
class LoginModel
{
    ...
    private static function validateAndGetUser($user_name, $user_password)
    {
        ...
        // 🔥 FIXED: removed broken syntax error block (was causing crash)
    ...
    public static function setSuccessfulLoginIntoSession($user_id, $user_name, $user_email, $user_account_type)
    {
        ...
        setcookie(session_name(), session_id(), time() + Config::get('SESSION_RUNTIME'),
    ...
    public static function setRememberMeInDatabaseAndCookie($user_id)
    {
        ...
        setcookie('remember_me', $cookie_string, time() + Config::get('COOKIE_RUNTIME'),
            Config::get('COOKIE_PATH'),
            Config::get('COOKIE_DOMAIN'),
            Config::get('COOKIE_SECURE'),
            Config::get('COOKIE_HTTP'));
